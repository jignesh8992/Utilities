...
public final class LayoutControllerBinding implements ViewBinding {
  ...
  private LayoutControllerBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton backBtn,
  ...
  @NonNull
  public static LayoutControllerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutControllerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_controller, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutControllerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutControllerBinding((RelativeLayout) rootView, backBtn, centerPlayBtn,
