...
//    private boolean mFullscreenEnabled = false;
    ...
    public void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.pause_2);
            mCenterPlayButton.setImageResource(R.drawable.ic_pause);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.play_2);
            mCenterPlayButton.setImageResource(R.drawable.ic_play);
