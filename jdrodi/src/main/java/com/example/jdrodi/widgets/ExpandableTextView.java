...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private int mExpandCollapsedTextSize;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mExpandCollapsedTextSize = typedArray.getDimensionPixelSize(R.styleable.ExpandableTextView_expandCollapseTextSize, DEFAULT_CONTENT_TEXT_SIZE);
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.ic_more_down_arrow);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.ic_more_up_arrow);
        }
    ...
    private void findViews() {
        ...
        mStateTv.setTextSize(TypedValue.COMPLEX_UNIT_PX, mExpandCollapsedTextSize);
