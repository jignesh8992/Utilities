...
public class JProgress {
     ...
     */
    public static JProgress create(Context context) {
        return new JProgress(context);
    }
   ...
   * @return An unique HUD instance
   */
    public static JProgress create(Context context, Style style) {
        return new JProgress(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public JProgress setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public JProgress setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public JProgress setSize(int width, int height) {
     ...
     */
    @Deprecated
    public JProgress setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public JProgress setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public JProgress setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public JProgress setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public JProgress setLabel(String label) {
     ...
     * @return Current HUD
     */
    public JProgress setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public JProgress setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public JProgress setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public JProgress setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public JProgress setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public JProgress setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public JProgress setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public JProgress setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public JProgress setGraceTime(int graceTimeMs) {
        mGraceTimeMs = graceTimeMs;
        return this;
    }

    public JProgress show() {
        if (!isShowing()) {
            mFinished = false;
            if (mGraceTimeMs == 0) {
